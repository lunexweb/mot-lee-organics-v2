...
export default function SystemSettings() {
  ...
  const resetToDefaults = async () => {
    ...
    try {
      const defaultRates = [
        { id: '', level: 1, percentage: 0.20, is_active: true },
        { id: '', level: 2, percentage: 0.10, is_active: true },
        { id: '', level: 3, percentage: 0.08, is_active: true }
      ]
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <label className="block text-xs text-gray-500 mb-1">
                      {rate.level === 1 ? 'Direct (20% rec.)' : rate.level === 2 ? 'L2 (10% rec.)' : 'L3 (8% rec.)'}
                    </label>
