-- Create/Update Missing Database Functions for Dashboard
-- Handles existing functions gracefully

-- =====================================================
-- 1. DROP AND RECREATE GENEALOGY TREE FUNCTION
-- =====================================================
...
-- =====================================================
DROP FUNCTION IF EXISTS get_income_breakdown CASCADE;
...
SELECT 'Database functions created/updated successfully!' as result;
