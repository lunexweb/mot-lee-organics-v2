-- Complete Wallet & Dashboard Enhancement for Mot-Lee Organics
-- RUN THIS ONE FILE ONLY in Supabase SQL Editor
-- This adds all missing features from True Organics dashboard

-- =====================================================
-- 1. ADD COMMISSION_TYPE COLUMN TO COMMISSIONS TABLE
-- =====================================================
...
-- =====================================================
-- 10. INITIALIZE WALLETS FOR EXISTING USERS
-- =====================================================
INSERT INTO wallets (user_id, wallet_type, balance, available_for_withdrawal)
SELECT 
  id, 
